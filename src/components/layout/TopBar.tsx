    ...
    <header className="fixed top-0 w-full z-50 pt-safe bg-white border-b border-slate-200 shadow-xs">
      <div className="h-16 px-4 md:px-6 flex items-center justify-between max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* User Profile */}
          <Link
            to={role === 'buyer' ? '/buyer/profile' : '/app/profile'}
          ...
          >
            ...
            <div className="hidden xl:flex flex-col text-left">
              <span className="text-xs font-medium text-slate-800 leading-tight">Plant Ops</span>
              <span className="text-[10px] text-slate-500">Tier-1 Facility</span>
            </div>
          </Link>
        </div>
      </div>
